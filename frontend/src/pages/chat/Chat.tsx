						...
						<div className={styles.chatContainer}>
							{!messages || messages.length < 1 ? (
								<Stack className={styles.chatEmptyState}>
									...
									<h1 className={styles.chatEmptyStateTitle}>Virtual Assistant ASR BCA Finance</h1>
									<h2 className={styles.chatEmptyStateSubtitle}>Halo saya Virtual Assistant ASR BCA Finance, ada yang bisa di bantu ?</h2>
								</Stack>
							) : (
